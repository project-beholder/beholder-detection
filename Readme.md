# Beholder Detection
This is the marker detection component of Beholder. Current Version 1.1.14
...
```
<script src="https://unpkg.com/beholder-detection@1.1.14/dist/beholder-detection.js"></script>
```
