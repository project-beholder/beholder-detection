# Beholder Detection
This is the marker detection component of Beholder. Current Version 1.2.1
...
```
<script src="https://unpkg.com/beholder-detection@1.2.1/dist/beholder-detection.js"></script>
```
